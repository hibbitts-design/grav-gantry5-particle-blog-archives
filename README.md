# Gantry 5 'Blog Archives' Particle for Grav
...
3. Upload `blog_archives.html.twig` and `blog_archive.yaml` files into the `particles` folder. For example, if you are using the Helium theme copy the two particle files into `user/data/gantry5/themes/g5_helium/particles`.

## Particle Requirements
Grav [Archives](https://getgrav.org/downloads/plugins) Plugin

## Particle Options
!['Blog Archives' options](https://github.com/paulhibbitts/github-repo-images/blob/master/blog-archives-options.png?raw=true)
